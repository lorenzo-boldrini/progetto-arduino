	...
	LOD 0
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				float temp_output_7_0_g18638 = TVE_ElementFadeContrast;
				float2 temp_cast_0 = (temp_output_7_0_g18638).xx;
				half Enable_Fade_Support454_g18630 = _ElementFadeSupport;
				float lerpResult654_g18630 = lerp( 1.0 , ( 1.0 - saturate( ( pow( saturate( ( ( abs( (( (TVE_VolumeCoord).zw + ( (TVE_VolumeCoord).xy * (WorldPosition).xz ) )*2.0 + -1.0) ) - temp_cast_0 ) / ( 1.0 - temp_output_7_0_g18638 ) ) ) , 2.0 ).x + 0.0 ) ) ) , Enable_Fade_Support454_g18630);
				...
				float temp_output_7_0_g18636 = _MainTexMinValue;
				float4 temp_cast_1 = (temp_output_7_0_g18636).xxxx;
				float4 break469_g18630 = saturate( ( ( tex2DNode17_g18630 - temp_cast_1 ) / ( _MainTexMaxValue - temp_output_7_0_g18636 ) ) );
...
ASEEND*/
//CHKSM=62C1910C233BA7883EBF1D5F2E914BAE2E4BEAA5