	...
	LOD 0
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half lerpResult654_g18625 = lerp( 1.0 , ( 1.0 - saturate( ( pow( saturate( ( ( abs( (( (TVE_VolumeCoord).zw + ( (TVE_VolumeCoord).xy * (WorldPosition).xz ) )*2.0 + -1.0) ) - temp_cast_0 ) / ( 1.0 - temp_output_7_0_g18634 ) ) ) , 2.0 ).x + 0.0 ) ) ) , Enable_Fade_Support454_g18625);
				...
				half temp_output_9_0_g18629 = lerpResult233_g18625;
				half sRGB8_g18629 = temp_output_9_0_g18629;
				half localGammaToLinearFloatFast8_g18629 = GammaToLinearFloatFast( sRGB8_g18629 );
				#ifdef UNITY_COLORSPACE_GAMMA
				float staticSwitch1_g18629 = temp_output_9_0_g18629;
				#else
				float staticSwitch1_g18629 = localGammaToLinearFloatFast8_g18629;
				#endif
				half3 appendResult239_g18625 = (half3(0.0 , 0.0 , staticSwitch1_g18629));
				...
				half temp_output_7_0_g18632 = _MainTexMinValue;
				half4 temp_cast_1 = (temp_output_7_0_g18632).xxxx;
				half4 break469_g18625 = saturate( ( ( tex2DNode17_g18625 - temp_cast_1 ) / ( _MainTexMaxValue - temp_output_7_0_g18632 ) ) );
...
ASEEND*/
//CHKSM=7F3CBF9B1B677E20EB2A6D831326E938F329E4C7