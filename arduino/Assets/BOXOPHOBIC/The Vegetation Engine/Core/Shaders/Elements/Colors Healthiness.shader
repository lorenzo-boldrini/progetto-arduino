...
Shader "BOXOPHOBIC/The Vegetation Engine/Elements/Default/Colors Healthiness"
{
	Properties
	{
	...
	LOD 0
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				#endif
				half3 Final_Subsurface_RGB365_g18619 = half3(0,0,0);
				half Value_Main157_g18619 = _MainValue;
				half TVE_SeasonOptions_X50_g18619 = TVE_SeasonOptions.x;
				half Value_Winter158_g18619 = _AdditionalValue1;
				half temp_output_427_0_g18619 = ( 1.0 - Value_Winter158_g18619 );
				half Value_Spring159_g18619 = _AdditionalValue2;
				half temp_output_428_0_g18619 = ( 1.0 - Value_Spring159_g18619 );
				half TVE_SeasonLerp54_g18619 = TVE_SeasonLerp;
				half lerpResult419_g18619 = lerp( temp_output_427_0_g18619 , temp_output_428_0_g18619 , TVE_SeasonLerp54_g18619);
				half TVE_SeasonOptions_Y51_g18619 = TVE_SeasonOptions.y;
				half Value_Summer160_g18619 = _AdditionalValue3;
				half temp_output_429_0_g18619 = ( 1.0 - Value_Summer160_g18619 );
				half lerpResult422_g18619 = lerp( temp_output_428_0_g18619 , temp_output_429_0_g18619 , TVE_SeasonLerp54_g18619);
				half TVE_SeasonOptions_Z52_g18619 = TVE_SeasonOptions.z;
				half Value_Autumn161_g18619 = _AdditionalValue4;
				half temp_output_430_0_g18619 = ( 1.0 - Value_Autumn161_g18619 );
				half lerpResult407_g18619 = lerp( temp_output_429_0_g18619 , temp_output_430_0_g18619 , TVE_SeasonLerp54_g18619);
				half TVE_SeasonOptions_W53_g18619 = TVE_SeasonOptions.w;
				half lerpResult415_g18619 = lerp( temp_output_430_0_g18619 , temp_output_427_0_g18619 , TVE_SeasonLerp54_g18619);
				...
				half lerpResult654_g18619 = lerp( 1.0 , ( 1.0 - saturate( ( pow( saturate( ( ( abs( (( (TVE_VolumeCoord).zw + ( (TVE_VolumeCoord).xy * (WorldPosition).xz ) )*2.0 + -1.0) ) - temp_cast_0 ) / ( 1.0 - temp_output_7_0_g18634 ) ) ) , 2.0 ).x + 0.0 ) ) ) , Enable_Fade_Support454_g18619);
				...
				half temp_output_9_0_g18631 = lerpResult388_g18619;
				half sRGB8_g18631 = temp_output_9_0_g18631;
				half localGammaToLinearFloatFast8_g18631 = GammaToLinearFloatFast( sRGB8_g18631 );
				#ifdef UNITY_COLORSPACE_GAMMA
				float staticSwitch1_g18631 = temp_output_9_0_g18631;
				#else
				float staticSwitch1_g18631 = localGammaToLinearFloatFast8_g18631;
				#endif
				half Final_Subsurface_A363_g18619 = staticSwitch1_g18631;
				half4 appendResult476_g18619 = (half4(Final_Subsurface_RGB365_g18619 , Final_Subsurface_A363_g18619));
				
				
				finalColor = appendResult476_g18619;
				return finalColor;
			}
			ENDCG
		}
...
ASEEND*/
//CHKSM=40696CA79629D2E2B80F5B91EB99226335C28424